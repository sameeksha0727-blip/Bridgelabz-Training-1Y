public class RouteTrackerSystem {
    public static void main(String[] args) {
        ...
        driver.routeHistory.addCheckpoint(new DeliveryCheckpoint("C1", "Warehouse A", 50.0, 60, 70));
        driver.routeHistory.addCheckpoint(new FuelCheckpoint("C2", "Pump 12", 20.0, 15, 15));
        driver.routeHistory.addCheckpoint(new RestCheckpoint("C3", "Motel X", 40.0, 60, 95));
        driver.routeHistory.addCheckpoint(new DeliveryCheckpoint("C4", "Client Hub", 10.0, 30, 45));
